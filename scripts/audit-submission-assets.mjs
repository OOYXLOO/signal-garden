...
const textExpectations = [
  {
    ...
    fragments: [
      ...
      "feedback-award-submission-brief.md",
  ...
  },
  {
    ...
    fragments: [
      ...
      "Signal Garden Devpost project entry",
      "actionable comments",
  ...
  {
    file: "docs/feedback-award-submission-brief.md",
    fragments: [
  ...
  {
    file: "docs/batch-submission-desk.md",
    fragments: [
      ...
      "Judge desk",
      "Source repository",
      "Reddit demo post draft",
      "Developer feedback form pack",
      "Copy Blocks",
  ...
  {
    file: "docs/public-proof-checklist.md",
    fragments: [
  ...
  {
    file: "docs/launch-proof-template.md",
    fragments: [
      "Signal Garden Launch Proof Template",
      "Audience And First-Minute Promise",
      "Reviewer Fast Path",
      "Public Proof Checklist",
      "Screenshot And Video Shot List",
      "Submission Field Handoff",
      "Missing Evidence And Risk Notes",
      "Reusable Review Receipt",
      "public judge desk",
      "sample route",
      "Submission manifest",
    ],
  ...
  },
  {
    ...
    fragments: [
      ...
      "sample route",
      "sample preview",
      "multi-contributor sample preview",
