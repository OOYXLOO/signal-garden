...
2. Sample route: https://ooyxloo.github.io/signal-garden/?day=2026-06-24&sample=1
...
```text
npm run export:submission-pack -- --public-app-url 'https://ooyxloo.github.io/signal-garden/' --source-repo-url 'https://github.com/OOYXLOO/signal-garden' --day '2026-06-24' --sample-route --allow-pending-platform-gates --feedback-url 'https://forms.gle/YByxxCneDsn174qb9'
```
### Final pack command

```text
npm run export:submission-pack -- --public-app-url 'https://ooyxloo.github.io/signal-garden/' --source-repo-url 'https://github.com/OOYXLOO/signal-garden' --day '2026-06-24' --sample-route --app-listing-url '<public-app-listing-url>' --demo-post-url '<public-demo-post-url>' --feedback-url 'https://forms.gle/YByxxCneDsn174qb9'
```
