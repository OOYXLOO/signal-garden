...
```powershell
npm run export:devpost-fields -- --public-app-url 'https://signal-garden.vercel.app/' --source-repo-url 'https://github.com/OOYXLOO/signal-garden' --day '2026-06-29' --app-listing-url '<public-app-listing-url>' --demo-post-url '<public-demo-post-url>'
```
...
```powershell
npm run export:submission-pack -- --public-app-url 'https://signal-garden.vercel.app/' --day '2026-06-29' --sample-route --source-repo-url 'https://github.com/OOYXLOO/signal-garden' --app-listing-url '<public-app-listing-url>' --demo-post-url '<public-demo-post-url>'
npm run audit:submission
```
