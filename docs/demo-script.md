...
8. Show the comment challenge, review snapshot, and daily recap.
   - Say: "The comment prompt invites routes back in, and the review snapshot gives judges the route, consensus, and reproducibility checks in one copy."
   - Show the comment challenge with a Review link, the review snapshot, then the recap text with route count and contributor lead.
