...
8. Show the comment challenge, Reddit post draft, review snapshot, submission readiness, launch packet, and daily recap.
   - Say: "The comment prompt invites routes back in, the readiness checklist shows what is reviewable now, and the launch packet gathers the demo-post setup in one copy."
   - Show the comment challenge with a Review link, the Reddit post draft, the review snapshot, the readiness checklist, the launch packet sections, then the recap text with route count and contributor lead.
