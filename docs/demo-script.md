...
1. Open on the full board.
   ...
   - Show the date chip, board title, move limit, and three beacons.
...
4. Clear and apply the top proposal.
...
Daily Phaser puzzle with seven verified board templates, local proposal consensus, a compact archive/streak loop, completion feedback, and a Devvit-ready adapter boundary.
