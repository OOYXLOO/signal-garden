...
- Daily sample route: https://ooyxloo.github.io/signal-garden/?day=2026-06-26&sample=1
...
| --- | --- | --- |
| Submission window | Submissions close July 15, 2026 at 6:00 PM Pacific; 20 days remain. Rules source: https://redditgameswithahook.devpost.com/rules | ready |
...
| Daily challenge | Each date resolves to a deterministic puzzle and a shareable sample route, so a subreddit can play one compact challenge per day. | https://ooyxloo.github.io/signal-garden/?day=2026-06-26&sample=1, src/game/puzzle.js, docs/demo-script.md |
