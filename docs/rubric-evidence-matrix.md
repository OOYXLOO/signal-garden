...
- Daily sample route: https://signal-garden.vercel.app/?day=2026-07-01&sample=1
...
| --- | --- | --- |
| Submission window | Submissions close July 15, 2026 at 6:00 PM Pacific; 15 days remain. Rules source: https://redditgameswithahook.devpost.com/rules | ready |
| Working project access | Public Vercel production app, deterministic sample route, judge desk, and public URL audit. | ready |
...
| Daily challenge | Each date resolves to a deterministic puzzle and a shareable sample route, so a subreddit can play one compact challenge per day. | https://signal-garden.vercel.app/?day=2026-07-01&sample=1, src/game/puzzle.js, docs/demo-script.md |
